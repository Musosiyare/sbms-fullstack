...
router.post("/", ctrl.open); // Dean of Discipline or Manager: start a discussion on a record
...
router.patch("/:id/close", ctrl.close); // Dean of Discipline or Manager
router.patch("/:id/reopen", ctrl.reopen); // Dean of Discipline or Manager
